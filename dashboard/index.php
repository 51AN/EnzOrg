...
<?php
    $sql = "
    ((SELECT * FROM projects WHERE user_id = $userId and priority = 'High' and projstatus != 'Completed') UNION 
    (
        SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id FROm projects INNER JOIN projmembers ON projects.proj_id = projmembers.projID WHERE projmembers.userID = $userId and priority = 'High' and projstatus != 'Completed' 
    ))
    UNION
    ((SELECT * FROM projects WHERE user_id = $userId and priority = 'Medium' and projstatus != 'Completed') UNION 
    (
        SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id FROm projects INNER JOIN projmembers ON projects.proj_id = projmembers.projID WHERE projmembers.userID = $userId and priority = 'Medium' and projstatus != 'Completed'
    ))
    UNION
    ((SELECT * FROM projects WHERE user_id = $userId and priority = 'Low' and projstatus != 'Completed') UNION 
    (
        SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id FROm projects INNER JOIN projmembers ON projects.proj_id = projmembers.projID WHERE projmembers.userID = $userId and priority = 'Low' and projstatus != 'Completed'
    ))
    UNION
    ((SELECT * FROM projects WHERE user_id = $userId and priority = 'High' and projstatus = 'Completed') UNION 
    (
    ...
    $fetchMyProjList = mysqli_query($conn, "(SELECT * FROM projects WHERE user_id = $userId and priority ='High' and projstatus != 'Completed')
                                            UNION 
                                            (SELECT * FROM projects WHERE user_id = $userId and priority ='Medium' and projstatus != 'Completed')
                                            UNION
                                            (SELECT * FROM projects WHERE user_id = $userId and priority ='Low' and projstatus != 'Completed')
                                            UNION
                                            (SELECT * FROM projects WHERE user_id = $userId and priority ='High' and projstatus = 'Completed')
                                            UNION 
                                            (SELECT * FROM projects WHERE user_id = $userId and priority ='Medium' and projstatus = 'Completed')
                                            UNION
                                            (SELECT * FROM projects WHERE user_id = $userId and priority ='Low' and projstatus = 'Completed')
    ...
    $fetchAssignedProjs = mysqli_query($conn, "(SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id 
                                            ...
                                            WHERE projmembers.userID = $userId and priority = 'High' and projstatus != 'Completed') 
                                            UNION
                                            (SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id 
                                            FROm projects INNER JOIN projmembers
                                            ON projects.proj_id = projmembers.projID
                                            WHERE projmembers.userID = $userId and priority = 'Medium' and projstatus != 'Completed') 
                                            UNION
                                            (SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id 
                                            FROm projects INNER JOIN projmembers
                                            ON projects.proj_id = projmembers.projID
                                            WHERE projmembers.userID = $userId and priority = 'Low' and projstatus != 'Completed') 
                                            UNION
                                            (SELECT proj_id, projname, projdescription, priority, projstatus, due, user_id 
                                            FROm projects INNER JOIN projmembers
                                            ON projects.proj_id = projmembers.projID
